...
CARS = { 'авео', 'ауди', 'ауди80', 'акура',
          'баргузин', 'бмв', 'бумер', 'буханка', 'белаз', 'беларусь', 'беларус', 'балено',
            'ваз', 'ваз1', 'ваз2','ваз3', 'ваз4', 'ваз5', 'веста', 'витязь', 'волга', 'вольво',
           'витара',
          'газ', 'газель', 'гранта', 'газ24', 'газ53', 'газ69','газ66', 'газон', 'гранд витара',
          'даф', 'дастер', 'деу', 'джимни',
          'жук',
          'запорожец', 'зил', 'зис', "зис-5",
          'ивеко', 'иж', 'импала', 'инфинити', 'исузу',
          'камаз', 'камаро', 'камри', 'катер','квадроцикл',
         'кеди', 'кировец', 'кия', 'краз', 'кран', 'кировец', 'круз',
           'копейка',
          'лада', 'лада2101', 'лада2110', 'лада2111', 'лада2104', 'лада2106', 'лада2108',
         'лада2105', 'лада2101', 'лада самара', 'лада21099',
         'лаз', 'лансер','ланос', 'лачети', 'лексус', 'лиаз',  'лимузин','лифан', 'лодка',
          'маз', 'мазда', 'маршрутка', 'мерседес', 'мини', 'мицубиси', 'мопед',
         'москвич', 'москвич412', 'москвич 412', 'мото', 'мопед', 'мотоцикл', "мотороллер",
          'моцат', 'мтз',
          'нива', "ниссан",
          'ока', 'опель',
         ...
         'прямоток', 'прямоход',
          ...
          'уаз', 'урал',
          'ферари', 'фиат', 'форд', 'фура', 'форестер',
          'хавал', 'хендай','хонда',
          'чайка', 'черри',
          'шахман', 'шевроле', 'шевиван', 'шеви нова',
          'эскаватор', 'юпитер',
          'ягуар'
}
CAR_EN = {
...
URLS = {
    ...
    'лексус1': ('https://www.youtube.com/watch?v=mfVEzUS7l54', 220),
